...
namespace excel2json
{
    class XmlExporter
    {
        ...
        public XmlExporter(List<ExcelParser.TableInfo> tableInfos, string excelName, HashSet<string> exportTags)
        {
            _context = ConvertSheet(tableInfos, excelName, exportTags);
        }
