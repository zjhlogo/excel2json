...
{
    /// <summary>
    /// 将DataTable对象，转换成Xml string，并保存到文件中
    /// </summary>
    class XmlExporter
    {
        string mContext = "";
        ...
        public XmlExporter(ExcelLoader excel, bool lowcase, bool exportArray, string dateFormat, bool forceSheetName, int headerRows, string excludePrefix, bool cellJson)
        {
